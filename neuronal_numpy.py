...
# Coordenadas de Karkaus, Concepcion
datos_karkaus = circulo(num_datos=N, R=1, latitud=-23.442503, longitud=-58.443832)
datos_concepcion = circulo(num_datos=N, R=1, latitud=-23.406576, longitud=-57.430455)
